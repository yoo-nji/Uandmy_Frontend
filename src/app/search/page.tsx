  ...
  return (
    <div className="w-[23.4375rem] min-h-screen bg-[#F6F6F6]">
      <div className="w-full px-[.9375rem] pt-11 pb-6 bg-white">
        ...
        <div className="mt-2 mb-[1.5625rem] h-6 flex justify-end items-center gap-x-1.5">
      ...
      <div className="w-full">
        {/* 검색 결과 */}
        <div className="px-[.9375rem] pb-[3.375rem] border-t-8 border-[#F2F2F2]">
        ...
        {/* 추천 결과 */}
        <div className="px-[.9375rem] pb-20 border-t-8 border-[#F2F2F2] bg-white">
